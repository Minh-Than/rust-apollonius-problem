use egui::{epaint::CircleShape, Color32, Context, Pos2, Rect, Stroke, Ui};

use crate::{calc, enums::dragging::Dragging, models::{segment::Segment, straightline::StraightLine}, MyApp};
    ...
    egui::CentralPanel::default().show(ctx, |ui| {
        ...
        let response = scene.show(
            ...
            |ui: &mut Ui| {
                ...
                let radical_center: Pos2 = calc::find_intersection(&radical_axes[0], &radical_axes[1]);
                ...
                let inv_pole_set_1: InversePoleSet = InversePoleSet { 
                    ...
                    s1: calc::get_circle_straight_line_intersection(&Segment (calc::get_inverse_pole(&line_1, app.circle_1), radical_center).as_straight_line(),app.circle_1), 
                    s2: calc::get_circle_straight_line_intersection(&Segment (calc::get_inverse_pole(&line_1, app.circle_2), radical_center).as_straight_line(),app.circle_2),  
                    s3: calc::get_circle_straight_line_intersection(&Segment (calc::get_inverse_pole(&line_1, app.circle_3), radical_center).as_straight_line(),app.circle_3) 
                };
                let inv_pole_set_2: InversePoleSet = InversePoleSet { 
                    ...
                    s1: calc::get_circle_straight_line_intersection(&Segment (calc::get_inverse_pole(&line_2, app.circle_1), radical_center).as_straight_line(),app.circle_1), 
                    s2: calc::get_circle_straight_line_intersection(&Segment (calc::get_inverse_pole(&line_2, app.circle_2), radical_center).as_straight_line(),app.circle_2),  
                    s3: calc::get_circle_straight_line_intersection(&Segment (calc::get_inverse_pole(&line_2, app.circle_3), radical_center).as_straight_line(),app.circle_3) 
                };
                let inv_pole_set_3: InversePoleSet = InversePoleSet { 
                    ...
                    s1: calc::get_circle_straight_line_intersection(&Segment (calc::get_inverse_pole(&line_3, app.circle_1), radical_center).as_straight_line(),app.circle_1), 
                    s2: calc::get_circle_straight_line_intersection(&Segment (calc::get_inverse_pole(&line_3, app.circle_2), radical_center).as_straight_line(),app.circle_2),  
                    s3: calc::get_circle_straight_line_intersection(&Segment (calc::get_inverse_pole(&line_3, app.circle_3), radical_center).as_straight_line(),app.circle_3) 
                };
                let inv_pole_set_4: InversePoleSet = InversePoleSet { 
                    ...
                    s1: calc::get_circle_straight_line_intersection(&Segment (calc::get_inverse_pole(&line_4, app.circle_1), radical_center).as_straight_line(),app.circle_1), 
                    s2: calc::get_circle_straight_line_intersection(&Segment (calc::get_inverse_pole(&line_4, app.circle_2), radical_center).as_straight_line(),app.circle_2),  
                    s3: calc::get_circle_straight_line_intersection(&Segment (calc::get_inverse_pole(&line_4, app.circle_3), radical_center).as_straight_line(),app.circle_3) 
                };
...
fn draw_inverse_poles(ui: &mut Ui, poles_set: InversePoleSet, fill: Color32, condition: bool) {
    if !condition { return; }
    for center in poles_set.into_iter() {
        ui.painter().add(egui::Shape::Circle(CircleShape { 
            center, 
            radius: 2.0, 
            fill, 
